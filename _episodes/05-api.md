...
Please note: These pages are autogenerated. Some of the API-calls fails during
...
~~~
Error in library(danstat): there is no package called 'danstat'
~~~
{: .error}
...
~~~
Error in get_data("folk1c", variables): could not find function "get_data"
~~~
{: .error}
...
~~~
Error in get_subjects(): could not find function "get_subjects"
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'subjects' not found
~~~
{: .error}
...
~~~
Error in get_subjects(subjects = 1): could not find function "get_subjects"
~~~
{: .error}
...
~~~
Error in get_subjects("3401"): could not find function "get_subjects"
~~~
{: .error}
...
~~~
Error in get_subjects(1, recursive = T, include_tables = T): could not find function "get_subjects"
~~~
{: .error}
...
~~~
Error in get_tables(subjects = "20021"): could not find function "get_tables"
~~~
{: .error}
...
~~~
Error in get_table_metadata("FOLK1A", variables_only = T): could not find function "get_table_metadata"
~~~
{: .error}
...
~~~
Error in slice(., 4): object 'metadata' not found
~~~
{: .error}
...
~~~
Error in slice(., 1): object 'metadata' not found
~~~
{: .error}
...
~~~
Error in get_data(table_id = "FOLK1A", variables = variables): could not find function "get_data"
~~~
{: .error}
...
~~~
Error in change_decimal_separator(x, decimal_mark = ","): is.data.frame(x) is not TRUE
~~~
{: .error}
